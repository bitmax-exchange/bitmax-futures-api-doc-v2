...
# but without the added background, and changed styling for JSON keys to be soft_green instead of white
    ...
    module Themes
      class MonokaiSublimeSlate < CSSTheme
        ...
        style Literal::Number::Float,
              ...
              Literal::String::Symbol,          :fg => :light_orange
        ...
        style Name::Variable::Class,
              ...
              Text,
              Name,                             :fg => :white
        style Name::Label,                      :fg => :bright_yellow
        style Operator::Word,
              Name::Tag,
              Keyword,
              Keyword::Namespace,
              Keyword::Pseudo,
              Operator,                         :fg => :bright_yellow
      end
    end
  end
